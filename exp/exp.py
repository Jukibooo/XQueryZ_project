...
queries = {
					...
					'$v/descendant::other/parent::source': 'axis:parent(axis:descendant($v, "othor"), "source")',
					...
					'$v/descendant::initial/ancestor-or-self::author': 'axis:ancestor-or-self(axis:descendant($v, "initial"), "author")'
